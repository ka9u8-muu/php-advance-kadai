...
// submitパラメータが存在する時(「登録」ボタンを押した時)の処理
if(isset($_POST['submit'])){
    try{
        $pdo = new PDO($dsn, $user, $password);

        // 動的に変わる値をプレースホルダに置き換えたINSERT文を予め用意
        $sql_insert ='
...
try{
    ...
    // vendorsテーブルからvendor_codeカラムのデータを取得
                ...
                <article class="registration">
                    ...
                    <form action="create.php" method="post" class="registration-form">
                        <div>
                            ...
                            <input type="number" id="book_code" name="book_code" min="0" max="10000000" required>
